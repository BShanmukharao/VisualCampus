...
import { faBell, faPowerOff, faCircleArrowLeft } from '@fortawesome/free-solid-svg-icons';
import './Headerjquery'
import './Header.css'
...
function Header() {
    ...
    return (
        <div className='header-bg-container'>
            <div>
                <a data-toggle="tooltip" data-placement="top" title="Toggle sidebar"><FontAwesomeIcon icon={faCircleArrowLeft} className="hamburger-menu" id="header-arrow-icon"/></a>
            </div>
